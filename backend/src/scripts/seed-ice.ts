...
export default async function seedIceData({ container }: ExecArgs) {
  ...
  const products: any[] = [
    ...
    },
    {
      ...
      metadata: { color_images: { Noir: productImages.tshirtMLLineaNebula } },
      weight: 250,
      options: [{ title: "Couleur", values: ["Noir"] }, { title: "Taille", values: ["S", "M", "L", "XL"] }],
      variants: colorSizeVariants(95, "ICE-TMLN", ["Noir"]),
    },
    ...
    },
    {
      ...
      metadata: { color_images: { Gris: productImages.joggingOscura } },
      weight: 420,
      options: [{ title: "Couleur", values: ["Gris"] }, { title: "Taille", values: ["S", "M", "L", "XL"] }],
      variants: colorSizeVariants(95, "ICE-JO", ["Gris"]),
    },
    ...
    // ── PIÈCES STANDALONE ──
    {
      ...
      metadata: { compare_at_price: 300, color_images: { Noir: productImages.doudouneIceVest } },
      weight: 350,
      options: [{ title: "Couleur", values: ["Noir"] }, { title: "Taille", values: ["S", "M", "L", "XL"] }],
      variants: colorSizeVariants(240, "ICE-VEST", ["Noir"]),
    },
    {
      ...
      metadata: { color_images: { Noir: productImages.downJacketPolaris } },
      weight: 800,
      options: [{ title: "Couleur", values: ["Noir"] }, { title: "Taille", values: ["S", "M", "L", "XL"] }],
      variants: colorSizeVariants(300, "ICE-POL", ["Noir"]),
    },
    ...
    // ── ACCESSOIRES ──
    {
      ...
      metadata: { color_images: { Noir: productImages.casquetteMountain } },
      weight: 80,
      options: [{ title: "Couleur", values: ["Noir"] }],
      variants: colorOnlyVariants(74.99, "ICE-CMTN", ["Noir"]),
    },
    {
