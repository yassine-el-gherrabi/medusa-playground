...
export default function StripePayment({
  ...
  if (loading) {
    return <div className="text-muted-foreground py-4">Chargement du paiement...</div>
  }
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Le paiement n&apos;est pas configure. Veuillez configurer Stripe dans l&apos;administration Medusa.
        </p>
        <button
          onClick={async () => {
            try {
