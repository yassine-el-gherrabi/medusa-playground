      ...
      >
        <nav className="h-16 px-6 lg:px-10 flex items-center" aria-label="Navigation principale">
          ...
          <div className="hidden lg:flex items-center gap-12 flex-1 justify-end">
            ...
            <button onClick={openDrawer} className="group relative text-[11px] font-normal tracking-[0.15em] uppercase cursor-pointer" aria-label={`Panier${cartCount > 0 ? `, ${cartCount} articles` : ""}`}>
          ...
          <div className="lg:hidden flex items-center gap-2 ml-auto">
            ...
            <button onClick={openDrawer} className="relative p-2 hover:opacity-70 cursor-pointer" aria-label={`Panier${cartCount > 0 ? `, ${cartCount} articles` : ""}`}>
