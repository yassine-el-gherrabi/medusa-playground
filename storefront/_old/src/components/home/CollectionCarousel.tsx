...
const DEMO_COLLECTIONS: Collection[] = [
  {
    ...
    title: "Capsule Hiver",
    handle: "voir-tout",
    metadata: { hero_image: "https://images.unsplash.com/photo-1523398002811-999ca8dec234?w=1200&q=80" },
  },
  {
    id: "demo-2",
    title: "Essentials",
    handle: "voir-tout",
    metadata: { hero_image: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=1200&q=80" },
  },
  {
    id: "demo-3",
    title: "Ice for Girls",
    handle: "ice-for-girls",
    metadata: { hero_image: "https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1200&q=80" },
  },
  {
    id: "demo-4",
    title: "Streetwear",
    handle: "voir-tout",
    metadata: { hero_image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&q=80" },
  },
]
...
export default function CollectionCarousel({ collections }: { collections: Collection[] }) {
  ...
  const getSetWidth = useCallback(() => {
    ...
    return (slideW + SLIDE_GAP) * data.length
  ...
  const slideWidthClass = isMobile
    ? `w-[${SLIDE_WIDTH_MOBILE}vw]`
    : `w-[${SLIDE_WIDTH_DESKTOP}vw]`
